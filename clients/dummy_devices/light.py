...
status_topic = f"home/devices/status/{client_id}"
...
def on_message(client, userdata, msg):
    ...
    if msg.topic == ack_topic:
        ...
        client.publish(sending_topic, json_data, True)
...
# Create an MQTT client instance and set the last will to 0 (to let the other clients know when it is disconnected)
client = mqtt.Client(client_id)
client.will_set(status_topic, "0", retain=True) 
